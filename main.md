# QPSK Simulation with Linear Equalizer

This file contains a full QPSK simulation including transmitter, channel, receiver, and MATLAB-style linear equalizer (`comm.LinearEqualizer` behavior).
